 ...
 */
public class UloTrQNodeSkin extends UloNodeSkin {
    ...
    /**
     * Creates a new {@link de.tesis.dynaware.grapheditor.demo.customskins.ulo.UloTrQNodeSkin} instance.
     *
     * @param node the {link GNode} this skin is representing
     */
    public UloTrQNodeSkin(final GNode node) {
        super(node, "TR-Q");
    }
