 ...
 */
public class UloTrNodeSkin extends UloNodeSkin {
    ...
    /**
     * Creates a new {@link de.tesis.dynaware.grapheditor.demo.customskins.ulo.UloTrNodeSkin} instance.
     *
     * @param node the {link GNode} this skin is representing
     */
    public UloTrNodeSkin(final GNode node) {
        super(node, "TR-N");
    }
